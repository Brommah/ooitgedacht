...
export const POPULAR_LOCATIONS = [
  { name: 'Amsterdam', region: 'Noord-Holland', avgLandPrice: 800 },
  { name: 'Utrecht', region: 'Utrecht', avgLandPrice: 650 },
  { name: 'Den Haag', region: 'Zuid-Holland', avgLandPrice: 550 },
  { name: 'Amersfoort', region: 'Utrecht', avgLandPrice: 500 },
  { name: 'Haarlem', region: 'Noord-Holland', avgLandPrice: 600 },
  { name: 'Almere', region: 'Flevoland', avgLandPrice: 350 },
  { name: 'Groningen', region: 'Groningen', avgLandPrice: 300 },
  { name: 'Eindhoven', region: 'Noord-Brabant', avgLandPrice: 450 },
];
